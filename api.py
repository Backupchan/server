...
class API:
    ...
    def add_routes(self):
        ...
        def new_target():
            ...
            try:
                target_id = self.db.add_target(data["name"], data["backup_type"], data["recycle_criteria"], data["recycle_value"], data["recycle_action"], data["location"], data["name_template"], data["deduplicate"], data["alias"], data["min_backups"], data["tags"])
        ...
        def edit_target(id):
            ...
            self.server_api.edit_target(id, data["name"], data["recycle_criteria"], data["recycle_value"], data["recycle_action"], data["location"], data["name_template"], data["deduplicate"], data["alias"], data["min_backups"], data["tags"])
